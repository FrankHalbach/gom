...
const forecast: Variant = createVariant(1, "Variant A");
const actual: Variant = createVariant(1, "Variant A");
...
actual.addVehicle("Vehicle B", 1570, 10, new Date(2019, 12, 1), new Date(2025, 1, 1));
